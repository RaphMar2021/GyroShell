...
namespace GyroShell.Settings
{
    public sealed partial class Customization : Page
    {
        ...
        bool? taskbarCentered = App.localSettings.Values["tbCenter"] as bool?;
        ...
        private void CenterTB_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {

            string choice = e.AddedItems[0].ToString();
            switch (choice)
            {
                case "Left":
                    App.localSettings.Values["tbCenter"] = false;
                    break;
                case "Center":
                    App.localSettings.Values["tbCenter"] = true;
                    break;
            }
        }
    }
